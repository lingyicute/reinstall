...
set confhome=https://raw.githubusercontent.com/lingyicute/reinstall/main
set confhome_cn=https://cnb.cool/lingyicute/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/lingyicute/reinstall/main
